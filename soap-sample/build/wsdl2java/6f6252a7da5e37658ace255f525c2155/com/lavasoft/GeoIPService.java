 ...
 * 2023-04-15T09:52:23.995+03:00
 * Generated source version: 4.0.0
 *
 */
@WebServiceClient(name = "GeoIPService",
                  wsdlLocation = "file:/C:/Course2/java_pft_from_git/soap-sample/src/main/resources/geoipservice.wsdl",
...
public class GeoIPService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Course2/java_pft_from_git/soap-sample/src/main/resources/geoipservice.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(GeoIPService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/C:/Course2/java_pft_from_git/soap-sample/src/main/resources/geoipservice.wsdl");
        }
        WSDL_LOCATION = url;
    }
